...
const LoginPage = () => {
  ...
  return (
    <div className='min-h-screen bg-cover bg-center flex items-center justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      ...
      {/* ------------------left---------------- */}
      <img className='w-64 h-64]' src={assets.logo_big} alt="" />
      ...
      <h2 className='font-medium text-2xl flex justify-between items-center'>
        ...
        {currState === "Sign up" && !isDataSubmitted &&(
          ...
          className='p-2 border border-gray-500 rounded-md focus:outline-none ' type="text" placeholder='Full Name' required/>
        ...
        {!isDataSubmitted && (
          ...
          type="email" placeholder='Email Address' required className='p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-2 focs:ring-indigo-500'/>
          <input onChange={(e)=> setPassword(e.target.value)} value={password}
          type="password" placeholder='Password' required className='p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-2 focs:ring-indigo-500'/>
          </>
        )}
